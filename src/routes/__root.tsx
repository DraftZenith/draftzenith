    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Draft Zenith",
          url: "https://zenith-scribe-collective.lovable.app",
          description: "A premium publishing platform for book discovery, indie author promotion, and editorial insights.",
        }),
      },
      {
        type: "application/ld+json",
